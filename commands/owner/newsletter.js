  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!text || text.trim().length === 0) {
        return extra.reply('❌ Please provide a WhatsApp channel link!\n\nExample: .newsletter https://whatsapp.com/channel/0029Vb78V290gcfOcvVPzL2w');
      }
      ...
      if (!inviteCode) {
        return extra.reply('❌ Could not extract invite code from the link!\n\nPlease provide a valid WhatsApp channel link.\nExample: https://whatsapp.com/channel/0029Vb78V290gcfOcvVPzL2w\n\nOr just the invite code: .newsletter 0029Vb78V290gcfOcvVPzL2w');
      }
