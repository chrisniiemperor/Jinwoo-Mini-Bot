...
<img src="utils/bot_image.jpg" alt="Jinwoo Bot" width="260">

</div>

Jinwok Bot Mini is a WhatsApp MD bot built on top of the **Baileys** library.  
...
<a href="https://github.com/chrisniiemperor/Hackex-MD/fork" target="_blank">
...
```bash
git clone https://github.com/chrisniiemperor/Hackex-MD.git
cd Knightbot-MD
```
...
<a href="https://whatsapp.com/channel/0029Vb78V290gcfOcvVPzL2w" target="_blank">
...
- **Chris Tech** – Main developer & maintainer  
